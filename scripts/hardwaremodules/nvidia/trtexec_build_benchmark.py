...
parser.add_argument('--onnx', default="onnx_models/tfkeras_inceptionv3_299x299_imagenet_.onnx",
...
parser.add_argument('--inputs_dir', default='/media/cdleml/128GB/Users/amozelli/tf_to_trt/inceptionv3/data/',
...
parser.add_argument('--loadEngine', default='trt_engine/tfkeras_inceptionv3_299x299_imagenet_.engine',
...
#build and benchmark (buildEngine flag set to true)
if args.buildEngine:
  args.saveEngine = args.onnx.split('/')[-1].split('.')[0]+'.engine'
