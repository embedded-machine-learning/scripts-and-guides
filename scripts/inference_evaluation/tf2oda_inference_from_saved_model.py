...
def visualize_images(detection_array, category_index, output_dir, min_score=0.5):
    '''
    ...
    for image_name, value in detection_array.items():
        ...
        if(max(scores)>=min_score):
            ...
            new_image_path = os.path.join(image_dir, image_name + "_det" + ".png")
            print("Save image {} to {}".format(image_name, new_image_path))
...
def main():
    ...
    parser.add_argument("-s", '--score', default=0.5, type=float,
    ...
    if args.run_detection:
        ...
        for image_name in imagelist:
            ...
            visualize_images(detection, category_index, args.output_dir, min_score=args.score)
