...
#python ~/tf2odapi/scripts-and-guides/scripts/training/tf2oda_evaluate_ckpt_performance.py 
#--pipeline_config_path=jobs/tf2oda_ssdmobilenetv2_320_320_coco17_D100_pedestrian.config 
#--model_dir=models/tf2oda_ssdmobilenetv2_320_320_coco17_D100_pedestrian 
#--checkpoint_dir=models/tf2oda_ssdmobilenetv2_320_320_coco17_D100_pedestrian
